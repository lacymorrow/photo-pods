              ...
              <div className="space-y-2">
                <p>
                  {hasVercel
                    ...
                    : "Connect your Vercel account to deploy projects directly from Photopods."}
                </p>
              </div>
            </CardContent>
            <CardFooter>
            ...
            <div className="space-y-2">
              <p>
                {hasGitHub
                  ...
                  : "Connect your GitHub account with OAuth to create repositories and deploy projects directly from Photopods."}
              </p>
            </div>
          </CardContent>
          <CardFooter>
