...
const ctx = (opts: {
	...
	pod: {
		...
		// canUpload gates on hasMediaCapacity (pod item cap, LAC-2913). The
		// privacy matrix exercises membership rules, not the cap, so keep the
		// pod well under MAX_MEDIA_PER_POD here.
		mediaCount: 0,
	},
	viewer: {
